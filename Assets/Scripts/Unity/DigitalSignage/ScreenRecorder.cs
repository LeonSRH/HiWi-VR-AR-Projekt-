...
using UnityEngine;
#pragma warning disable CS0105 // Die using-Direktive für "System.Collections" ist bereits vorher in diesem Namespace aufgetreten.
using System.Collections;
#pragma warning restore CS0105 // Die using-Direktive für "System.Collections" ist bereits vorher in diesem Namespace aufgetreten.
using System.IO;
using System;
...
public class ScreenRecorder : MonoBehaviour
{
    ...
    private string uniqueFilename(int width, int height)
    {
        ...
        var filename = string.Format("{0}/{5}_screen_{1}x{2}_{3}.{4}", folder, width, height, counter, format.ToString().ToLower(), prefix);
