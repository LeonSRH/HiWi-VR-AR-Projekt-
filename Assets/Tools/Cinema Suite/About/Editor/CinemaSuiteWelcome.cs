...
#else
#pragma warning disable CS0618 // "EditorWindow.title" ist veraltet: "Use titleContent instead (it supports setting a title icon as well)."
            base.title = TITLE;
#pragma warning restore CS0618 // "EditorWindow.title" ist veraltet: "Use titleContent instead (it supports setting a title icon as well)."
#endif
