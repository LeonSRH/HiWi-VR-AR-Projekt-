        ...
        static void Next()
        {
            ...
            if (!earlyExit)
            {
                ...
                foreach (GameObject go in Resources.FindObjectsOfTypeAll(typeof(GameObject)))
                {
                    ...
                    {
#pragma warning disable CS0618 // "PrefabUtility.GetPrefabType(Object)" ist veraltet: "Use GetPrefabAssetType and GetPrefabInstanceStatus to get the full picture about Prefab types."
#pragma warning disable CS0618 // "PrefabType" ist veraltet: "PrefabType no longer tells everything about Prefab instance."
                        if ((PrefabUtility.GetPrefabType(go) == PrefabType.PrefabInstance ||
#pragma warning restore CS0618 // "PrefabType" ist veraltet: "PrefabType no longer tells everything about Prefab instance."
#pragma warning restore CS0618 // "PrefabUtility.GetPrefabType(Object)" ist veraltet: "Use GetPrefabAssetType and GetPrefabInstanceStatus to get the full picture about Prefab types."
#pragma warning disable CS0618 // "PrefabType" ist veraltet: "PrefabType no longer tells everything about Prefab instance."
#pragma warning disable CS0618 // "PrefabUtility.GetPrefabType(Object)" ist veraltet: "Use GetPrefabAssetType and GetPrefabInstanceStatus to get the full picture about Prefab types."
