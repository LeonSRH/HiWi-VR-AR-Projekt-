...
public class qb_Help : qb_Window
{
	...
	public override void OnGUI()
	{
		...
		EditorGUILayout.BeginVertical(menuBlockStyle);
			...
			MenuListItem(true,"If no object is selected, QuickBrush will use the first (or leftmost) item in the list belonging to the currently isActive brush template");
		EditorGUILayout.EndVertical();
