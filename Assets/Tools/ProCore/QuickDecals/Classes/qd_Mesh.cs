...
#region Const
	...
	public static GameObject CreateDecal(Material mat, Rect uvCoords, float scale)
	{
		...
		#else
#pragma warning disable CS0618 // "Renderer.castShadows" ist veraltet: "Use shadowCastingMode instead."
		decal.GetComponent<MeshRenderer>().castShadows = false;
#pragma warning restore CS0618 // "Renderer.castShadows" ist veraltet: "Use shadowCastingMode instead."
		#endif
